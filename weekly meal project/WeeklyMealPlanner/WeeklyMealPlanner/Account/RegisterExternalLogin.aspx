<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="RegisterExternalLogin.aspx.vb" Inherits="WeeklyMealPlanner.RegisterExternalLogin" Async="true" %>

<%@ Import Namespace="WeeklyMealPlanner" %>
